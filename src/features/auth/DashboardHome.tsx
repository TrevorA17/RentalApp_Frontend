...
> = {
  RENTER: {
    ...
    summary:
      "Browse live listings, shortlist strong options, and follow every inquiry from one place.",
    actions: [
  ...
  AGENT: {
    ...
    summary:
      "Keep your profile credible, publish stronger listings, and respond to renter leads quickly.",
    actions: [
  ...
  LANDLORD: {
    ...
    summary:
      "Publish available units, improve descriptions, and stay on top of incoming interest.",
    actions: [
      { href: "/my-listings", label: "Manage listings" },
      { href: "/inquiries/received", label: "Review inquiries" },
      { href: "/my-listings/new", label: "Create with AI assist" },
  ...
  ADMIN: {
    ...
    summary:
      "Moderate listings, resolve reports, and keep platform trust visible from the UI.",
    actions: [
      ...
      >
        <Stack spacing={2.5}>
          ...
          <Typography variant="body2" color="text.secondary" maxWidth={720}>
            This workspace is wired to the live backend modules, so you can test
            browsing, saving, inquiries, moderation, and AI-assisted listing
            creation directly from the frontend.
          </Typography>
        </Stack>
      </Paper>
